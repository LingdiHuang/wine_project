...
BASE_URL = 'https://www.winemag.com/?s=&drink_type=wine&wine_type=Red&page={0}&search_type=reviews'
session = requests.Session()
HEADERS = headers = {'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36'
            }
DATA_DIR = 'data'
